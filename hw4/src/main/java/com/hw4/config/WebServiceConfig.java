...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    // http://localhost:8080/groups.wsdl
    @Bean(name = "groups")
    public DefaultWsdl11Definition groupsWsdl11Definition(XsdSchema groupsSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://www.hw4.com/groups");
        wsdl11Definition.setSchema(groupsSchema);
        return wsdl11Definition;
    }

    // http://localhost:8080/students.wsdl
    @Bean(name = "students")
    public DefaultWsdl11Definition studentsWsdl11Definition(XsdSchema studentsSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://www.hw4.com/students");
